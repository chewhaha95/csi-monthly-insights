...
function systemPrompt(serials, formation, weekly, pack, budget) {
  ...
  return [
    ...
    "2. Cite after each claim: weekly extracts in the form (Weekly brief, 22 June – 29 June 2026); serials in the exact form (SER M-02); pack extracts in the form (Pack — Manoeuvre & Expeditionary).",
